            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/admin/estudiantes/create') }}" class="btn btn-info"> Crear nuevo</a>
                    </div><!-- /.card-tools -->
                </div><!-- /.card-header -->
                        ...
                        <tbody>
                            ...
                            @foreach ($estudiantes as $estudiante)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $estudiante->apellidos }}</td>
                                    <td class="text-center align-middle">{{ $estudiante->ci }}</td>
                                    <td class="text-center align-middle">{{ $estudiante->usuario->email }}</td>
                                    <td class="text-center align-middle">
                                        <img src="{{ url($estudiante->foto) }}" alt="image estudiante" width="80px">
                                    </td>
