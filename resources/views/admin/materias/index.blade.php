            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/admin/materias/create') }}" class="btn btn-info"> Crear nuevo</a>
                    </div><!-- /.card-tools -->
                </div><!-- /.card-header -->
                        ...
                        <tbody>
                            ...
                            @foreach ($materias as $materia)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $materia->carrera->nombre }}</td> 
                                    <td class="align-middle">{{ $materia->nombre }}</td> 
                                    <td class="align-middle">{{ $materia->codigo }}</td> 
                                    <td class="text-center align-middle">
                                        <div class="btn-group" role="group">
                                            <a href="{{ url('/admin/materias/' . $materia->id . '/edit') }}" 
